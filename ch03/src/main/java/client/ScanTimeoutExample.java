...
public class ScanTimeoutExample {
	...
	public static void main(String[] args) throws IOException {
		...
		int scannerTimeout = (int) conf.getLong(HConstants.HBASE_CLIENT_SCANNER_TIMEOUT_PERIOD, -1); // co
																										// ScanTimeoutExample-1-GetConf
																										// Get currently
																										// configured
																										// lease
																										// timeout.
		...
		// vv ScanTimeoutExample
		try {
			Thread.sleep(scannerTimeout + 5000); // co ScanTimeoutExample-2-Sleep Sleep a little longer than the lease
													// allows.
