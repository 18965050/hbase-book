...
public class GetClosestRowBeforeExample {
	...
	public static void main(String[] args) throws IOException {
		...
		Get get1 = new Get(Bytes.toBytes("row3")); // co GetClosestRowBeforeExample-1-Get1 Attempt to read a row that
													// does not exist.
		...
		get2.setClosestRowBefore(true); // co GetClosestRowBeforeExample-2-Get2 Instruct the get() call to fall back to
		...
		Get get3 = new Get(Bytes.toBytes("row2")); // co GetClosestRowBeforeExample-3-Get3 Attempt to read a row that
													// exists.
		...
		Get get4 = new Get(Bytes.toBytes("row2")); // co GetClosestRowBeforeExample-4-Get4 Read exactly a row that
													// exists.
