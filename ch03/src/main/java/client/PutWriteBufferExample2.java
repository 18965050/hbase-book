...
public class PutWriteBufferExample2 {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Mutation> mutations = new ArrayList<Mutation>(); // co PutWriteBufferExample2-1-DoPut Create a list to hold
																// all mutations.
		...
		System.out.println("Result: " + res1); // co PutWriteBufferExample2-4-Get1 Try to load previously stored row,
		...
		System.out.println("Result: " + res2); // co PutWriteBufferExample2-6-Get2 Now the row is persisted and can be
												// loaded.
