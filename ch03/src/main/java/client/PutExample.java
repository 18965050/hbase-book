...
public class PutExample {
	...
	public static void main(String[] args) throws IOException {
		...
		put.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual1"), Bytes.toBytes("val1")); // co
																								// PutExample-4-AddCol1
																								// Add
																								// a
																								// column,
																								// whose
																								...
																								// the
																								// put.
		put.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual2"), Bytes.toBytes("val2")); // co
																								// PutExample-4-AddCol2
																								// Add
																								// another
																								// column,
																								// whose
		...
		table.put(put); // co PutExample-5-DoPut Store row with column into the
						// HBase table.
		table.close(); // co PutExample-6-DoPut Close table and connection
