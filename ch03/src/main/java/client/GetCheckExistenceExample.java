...
public class GetCheckExistenceExample {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Get 1 Size: " + result1.size()); // co GetCheckExistenceExample-3-Result1 Exists is "true",
																// while no cel was actually returned.
		System.out.println("Get 1 Value: " + Bytes.toString(val));

		Get get2 = new Get(Bytes.toBytes("row2"));
		get2.addFamily(Bytes.toBytes("colfam1")); // co GetCheckExistenceExample-4-Get2 Check for an entire family to
													// exist.
		...
		get3.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual9999")); // co GetCheckExistenceExample-5-Get3 Check
																				// for a non-existent column.
		...
		get4.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual9999")); // co GetCheckExistenceExample-6-Get4 Check
																				// for an existent, and non-existent
																				// column.
		get4.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual1"));
		get4.setCheckExistenceOnly(true);
		Result result4 = table.get(get4);

		System.out.println("Get 4 Exists: " + result4.getExists()); // co GetCheckExistenceExample-7-Result4 Exists is
																	// "true" because some data exists.
