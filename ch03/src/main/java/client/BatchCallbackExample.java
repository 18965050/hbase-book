...
public class BatchCallbackExample {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		List<Row> batch = new ArrayList<Row>(); // co BatchCallbackExample-2-CreateList Create a list to hold all
												// values.
		...
		for (int i = 0; i < results.length; i++) {
			System.out.println("Result[" + i + "]: type = " + // co BatchCallbackExample-9-Dump Print all results and
																// class types.
