...
public class IncrementSingleExample {
	...
	public static void main(String[] args) throws IOException {
		...
		long cnt1 = table.incrementColumnValue(Bytes.toBytes("20110101"), // co IncrementSingleExample-1-Incr1 Increase
																			// counter by one.
				Bytes.toBytes("daily"), Bytes.toBytes("hits"), 1);
		long cnt2 = table.incrementColumnValue(Bytes.toBytes("20110101"), // co IncrementSingleExample-2-Incr2 Increase
																			// counter by one a second time.
				Bytes.toBytes("daily"), Bytes.toBytes("hits"), 1);

		long current = table.incrementColumnValue(Bytes.toBytes("20110101"), // co IncrementSingleExample-3-GetCurrent
																				// Get current value of the counter
																				// without increasing it.
				Bytes.toBytes("daily"), Bytes.toBytes("hits"), 0);

		long cnt3 = table.incrementColumnValue(Bytes.toBytes("20110101"), // co IncrementSingleExample-4-Decr1 Decrease
																			// counter by one.
				Bytes.toBytes("daily"), Bytes.toBytes("hits"), -1);
