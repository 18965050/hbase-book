...
public class IncrementMultipleExample {
	...
	public static void main(String[] args) throws IOException {
		...
		increment1.addColumn(Bytes.toBytes("daily"), Bytes.toBytes("hits"), 1); // co IncrementMultipleExample-1-Incr1
																				// Increment the counters with various
																				// values.
		...
		Result result1 = table.increment(increment1); // co IncrementMultipleExample-2-Incr2 Call the actual increment
														// method with the above counter updates and receive the
														// results.

		for (Cell cell : result1.rawCells()) {
			System.out.println("Cell: " + cell + " Value: "
					+ Bytes.toLong(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength())); // co
																											// IncrementMultipleExample-3-Dump1
																											// Print the
																											// cell and
																											// returned
																											// counter
		...
		increment2.addColumn(Bytes.toBytes("daily"), Bytes.toBytes("hits"), 1); // co IncrementMultipleExample-4-Incr3
																				// Use positive, negative, and zero
																				// increment values to achieve the
